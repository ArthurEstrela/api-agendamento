...
-- Alterar agendamento para suportar cupom --
ALTER TABLE appointments ADD COLUMN coupon_id VARCHAR(36);
ALTER TABLE appointments ADD COLUMN discount_amount DECIMAL(19, 2) DEFAULT 0;
