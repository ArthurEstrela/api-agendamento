...
public class Appointment {
    ...
    // Fábrica estática: garante que todo agendamento nasça com status PENDING e cálculos feitos
    ...
    public void reschedule(LocalDateTime newStartTime) {
        ...
        calculateEndTime();
        this.status = AppointmentStatus.PENDING; // Exige nova confirmação/validação de horário
    }
