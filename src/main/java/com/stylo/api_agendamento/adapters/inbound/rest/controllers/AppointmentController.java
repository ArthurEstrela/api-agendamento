...
public class AppointmentController {
    ...
    public ResponseEntity<List<LocalTime>> getAvailableSlots(
        ...
        // E para os serviços, você precisaria buscar a lista de domínios ou ajustar o Input para IDs.
        var input = new GetAvailableSlotsUseCase.AvailableSlotsInput(
            professionalId, 
            LocalDate.parse(date),
            List.of() // Aqui você deve passar os serviços vindos do request ou uma lista vazia para busca geral
        );
